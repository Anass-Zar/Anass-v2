...
const Skills = () => {
  ...
  const BackEnd = ['Node.js', 'Express', 'MySQL', 'Laravel', 'MongoDB', 'Mongoose']
  const Tools = ['Git', 'Github', 'Postman', 'Render', 'Vs code']
  return (
    <div className="bg-gray-100 max-w-full">
      <h1 className='font-bold text-3xl pt-20 text-center text-blue-500'>My Skills</h1>
      <div className="grid justify-items-center grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-4 gap-y-12 pt-10 pb-20 lg:pt-14 lg:pb-28 px-4 lg:px-0 w-auto lg:w-[63rem] xl:w-[80%] mx-auto">
        <div className='grid gap-3 md:gap-6'>
          ...
          <hr className="w-4/5 border-t-2 border-zinc-400 mx-auto mb-3" />
