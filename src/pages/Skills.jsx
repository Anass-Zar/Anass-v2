...
const Skills = () => {
  ...
  return (
    <div className="bg-gray-100 max-w-full">
      <h1 className='font-bold text-3xl lg:text-4xl pt-20 text-center text-blue-500'>Skills</h1>
      <div className="grid justify-items-center grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-4 gap-y-6 pt-12 pb-20 lg:pt-14 lg:pb-28 px-4 w-auto lg:w-[63rem] mx-auto">
        ...
        <div className='grid gap-3 md:gap-6'>
          <div className='grid justify-items-center'>
            ...
            <h1 className='font-bold text-2xl text-center'>Tools</h1>
          </div>
          <hr className="w-4/5 border-t-2 border-zinc-400 mx-auto" />
          <div className='px-8 flex gap-x-6 gap-y-3 flex-wrap justify-center'>
            {Tools.map((skill, key) => (
